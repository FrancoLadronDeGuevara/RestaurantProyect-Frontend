...
import visaCards from "../../assets/images/cards.png";
  ...
  return (
    <Grid container maxWidth="xl" sx={{ my: 2, mx: "auto", height: "100%" }}>
      ...
      <Grid xs={12} sm={6} item sx={{ p: 2 }}>
        ...
        <Typography variant="h3" sx={{ color: "#ffc139", mt: 2 }}>
          $ {product?.price}
        </Typography>
        ...
        <Box sx={{ mt: 3, display: "flex", flexDirection: 'column', alignItems: {xs: 'center', sm: 'end'} }}>
          <Typography sx={{pl: 1, fontWeight: "bolder !important", width: 200 }}>
            Paga seguro con:
          </Typography>
          <Box component="img" src={visaCards} sx={{ width: 200 }} />
        </Box>
      </Grid>
    </Grid>
  );
